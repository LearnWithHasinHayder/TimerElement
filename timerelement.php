...
final class TimerElementExtension {
	...
	function frontend_assets_scripts(){
		wp_enqueue_script( "flipclock-js", plugins_url( "/assets/js/flipclock.min.js", __FILE__ ),null, time(), true );
		wp_enqueue_script( "timer-helper-js", plugins_url( "/assets/js/scripts.js", __FILE__ ),null, time(), true );
	}
